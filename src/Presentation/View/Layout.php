...
final class Layout
{
    ...
    public static function render(string $title, string $content, array $options = []): string
    {
        ...
        return '<!doctype html>'
            ...
            . '@media(max-width:767px){.list-toolbar-left{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:stretch;width:100%;flex:1 1 auto;}.list-toolbar-search-form{min-width:0;flex:1 1 auto;max-width:none;}.list-toolbar-left .filter-btn{justify-content:center;}.list-toolbar-right{width:100%;margin-left:0;}.list-toolbar-right .btn,.list-toolbar-right .filter-btn{flex:1 1 auto;justify-content:center;}}'
            ...
            // CSV 取込中の全画面オーバーレイ。<dialog> の top layer 上にも被せる必要があるため z-index は最大級。
            . '@keyframes csv-overlay-spin{to{transform:rotate(360deg);}}'
            . '.csv-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:2147483647;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;cursor:wait;}'
            . '.csv-overlay-spinner{width:56px;height:56px;border:5px solid rgba(255,255,255,0.25);border-top-color:#fff;border-radius:50%;animation:csv-overlay-spin .9s linear infinite;}'
            . '.csv-overlay-text{color:#fff;font-size:16px;font-weight:600;letter-spacing:0.05em;}'
            // カラム仕様の折りたたみ
            ...
            . '.quick-filter-block{display:grid;gap:8px;margin:0 0 12px;}'
            . '.quick-filter-tabs{display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin:0;padding-bottom:2px;}'
            ...
            . '.quick-filter-tabs-more{display:none;align-items:center;gap:6px;align-self:flex-start;padding:0;border:none;border-radius:0;background:transparent;color:var(--text-info);font-size:12px;font-weight:600;font-family:inherit;line-height:1.5;cursor:pointer;text-decoration:none;}'
            . '.quick-filter-tabs-more:hover{color:var(--text-heading);text-decoration:underline;}'
