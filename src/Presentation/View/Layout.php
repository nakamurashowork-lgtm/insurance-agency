    ...
    public static function render(string $title, string $content, array $options = []): string
    {
        ...
        return '<!doctype html>'
            ...
            . '.user-meta span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:180px;}'
                ...
                . '.mobile-menu summary{list-style:none;cursor:pointer;display:inline-flex;align-items:center;gap:8px;font-weight:700;border:1px solid var(--border-light);border-radius:999px;background:var(--bg-primary);padding:0 16px;min-height:44px;color:var(--text-primary);}'
                . '.mobile-menu summary::-webkit-details-marker{display:none;}'
                . '.mobile-menu[open] summary{background:var(--bg-hover-cool);border-color:var(--border-cool-accent);}'
            ...
            . '.btn-primary:hover{background:var(--bg-info-hover);}'
            ...
            . '.list-pager-link{display:inline-flex;align-items:center;justify-content:center;min-width:44px;height:44px;padding:0 12px;border:1px solid var(--border-light);border-radius:10px;background:var(--bg-primary);color:var(--text-primary);text-decoration:none;font-weight:700;font-variant-numeric:tabular-nums;white-space:nowrap;}'
            . '.list-pager-link:hover{background:var(--bg-hover-cool);border-color:var(--border-cool-accent);}'
            . '.list-pager-link.is-current{background:var(--bg-active-cool);border-color:var(--border-cool-accent);color:var(--text-info);}'
            . '.list-table{font-size:13px;}'
            . '.list-table th,.list-table td{padding:8px 12px;line-height:1.3;}'
            . '.list-table thead th{font-size:13px;color:var(--text-secondary);background:var(--bg-secondary);vertical-align:middle;border-bottom:0.5px solid var(--border-medium);}'
            . '.list-table td{border-bottom:0.5px solid var(--border-light);}'
            . '.list-table tbody tr:last-child td{border-bottom:none;}'
            . '.list-table tbody tr:hover td{background:var(--bg-hover-warm);}'
            ...
            . '.list-table-accident col.list-col-customer{width:22%;}'
            . '.list-table-accident col.list-col-date{width:96px;}'
            . '.list-table-accident col.list-col-product{width:110px;}'
            . '.list-table-accident col.list-col-assigned{width:88px;}'
            . '.list-table-accident col.list-col-status{width:136px;}'
            . '.list-table-accident col.list-col-priority{width:60px;}'
            . '.list-table-accident col.list-col-reminder{width:118px;}'
            . '.list-table-accident col.list-col-action{width:44px;}'
            . '.list-table-scase col.list-col-name{width:36%;}'
            . '.list-table-scase col.list-col-customer{width:22%;}'
            . '.list-table-scase col.list-col-type{width:88px;}'
            . '.list-table-scase col.list-col-rank{width:68px;}'
            . '.list-table-scase col.list-col-status{width:110px;}'
            . '.list-table-scase col.list-col-staff{width:96px;}'
            ...
            . '.list-table-activity col.list-col-user{width:90px;}'
            ...
            . '@media (max-width: 1024px){.site-header-inner{padding:12px;}.main-nav,.header-tools > .user-meta,.header-tools > form{display:none;}.mobile-only{display:block;}.brand-subtitle{white-space:normal;}.mobile-menu-panel{position:absolute;top:100%;right:0;margin-top:4px;min-width:220px;background:var(--bg-primary);border:1px solid var(--border-light);border-radius:14px;padding:12px;display:grid;gap:10px;box-shadow:0 18px 34px rgba(17,33,49,0.12);}.mobile-menu-link{display:block;padding:10px 12px;border-radius:10px;text-decoration:none;color:var(--text-primary);font-weight:700;background:var(--bg-subtle);}.mobile-menu-link.is-active{background:var(--bg-active-cool);color:var(--text-info);}.mobile-meta{padding:10px 12px;border-radius:10px;background:var(--bg-subtle);color:var(--text-secondary);display:grid;gap:2px;}.detail-top,.split-columns{grid-template-columns:1fr;}.kv-list{grid-template-columns:1fr;gap:6px;}.list-filter-field,.list-filter-field.is-date{grid-column:span 6;}.list-toolbar-actions{justify-content:flex-start;margin-left:0;width:100%;}.list-page-header-actions{margin-left:0;justify-content:flex-start;}.two-col,.metric-grid,.metric-grid-5{grid-template-columns:1fr;}.page-header{flex-wrap:wrap;}.page-header-meta{white-space:normal;}}'
            . '@media (max-width: 768px){.app-shell,.page-container{padding:16px 12px 28px;}.card{padding:16px;}.title{font-size:21px;}.grid{grid-template-columns:1fr;}.actions{align-items:flex-start;}.summary-line{display:block;}.summary-line p + p,.summary-line span + span{margin-top:6px;display:inline-flex;}.btn{min-height:44px;padding:10px 16px;}.btn-small{min-height:40px;padding:8px 14px;}.btn-large{min-height:48px;}.form-input,.form-select{min-height:44px;padding:10px 12px;font-size:14px;}.update-field input[type="text"],.update-field input[type="date"],.update-field select,.update-field textarea{min-height:44px;}.customer-create-grid input,.customer-create-grid select{min-height:44px;}.list-filter-field input,.list-filter-field select,.list-filter-field textarea{min-height:44px;padding:10px 12px;font-size:14px;}.modal-dialog-wide{width:min(760px,calc(100vw - 20px));max-height:calc(100vh - 20px);overflow:auto;padding:14px 14px 12px;}.modal-close-form{position:sticky;top:0;z-index:2;background:var(--bg-primary);padding-bottom:6px;}.customer-create-form{gap:12px;}.customer-create-form .modal-title{font-size:22px;}.customer-create-grid{grid-template-columns:1fr;gap:12px;}.customer-create-grid .form-field--full,.customer-create-grid .form-field--spacer{grid-column:span 1;}.customer-create-grid textarea{min-height:92px;}.dialog-actions{position:sticky;bottom:0;z-index:2;justify-content:stretch;padding-top:10px;padding-bottom:2px;}.dialog-actions .btn{flex:1 1 160px;}.list-page-header{display:grid;gap:10px;align-items:flex-start;}.list-page-header-actions{margin-left:0;width:100%;justify-content:flex-start;}.list-page-header-actions .btn{max-width:100%;}.list-filter-card{padding:0;}.list-filter-toggle{padding:14px 16px;}.list-filter-card form{padding:16px;}.list-filter-field,.list-filter-field.is-date,.modal-form-grid .list-filter-field,.modal-form-wide{grid-column:span 12;}.list-toolbar{display:grid;grid-template-columns:minmax(0,1fr);gap:12px;}.list-toolbar-actions{display:grid;justify-content:stretch;gap:10px;min-width:0;width:100%;}.list-toolbar:not(.list-toolbar-bottom) .list-toolbar-actions{grid-template-columns:minmax(0,1fr);width:100%;row-gap:8px;}.list-sort-summary{text-align:left;min-width:0;white-space:normal;overflow-wrap:anywhere;word-break:break-word;}.list-per-page-form{justify-content:flex-start;min-width:0;width:100%;}.list-select-inline > span{min-width:0;text-align:left;}.list-pager{justify-content:flex-start;flex-wrap:wrap;min-width:0;width:100%;}.list-pager-link{min-width:44px;padding:0 12px;}.table-card thead{display:none;}.table-card,.table-card tbody,.table-card tr,.table-card td{display:block;width:100%;}.table-card tr{border:1px solid var(--border-cool);border-radius:10px;padding:10px;margin-bottom:12px;background:var(--bg-primary);}.list-table tbody tr.is-completed-row{background:var(--bg-subtle);}.table-card td{border-bottom:none;padding:4px 0;text-align:left;background:transparent !important;min-width:0;}.table-card td::before{content:attr(data-label);display:block;font-size:12px;font-weight:700;color:var(--text-hint);margin-bottom:2px;}.table-card td .truncate,.table-card td .list-policy-text,.table-card td .list-row-primary,.table-card td .list-row-secondary,.table-card td .list-row-tertiary{white-space:normal;overflow:visible;text-overflow:clip;overflow-wrap:anywhere;word-break:break-word;max-width:100%;}.table-wrap{overflow-x:visible;}th,td{padding:7px;font-size:14px;}.cell-action{text-align:left;}.table-card td[style*="text-align:center"],.table-card td[style*="text-align:right"]{text-align:left !important;}.table-card td.td-pair{display:inline-block !important;width:49%;vertical-align:top;}.table-card td.td-triple{display:inline-block !important;width:32%;vertical-align:top;}}'
            ...
            . '@media (max-width: 480px){.search-row{flex-direction:column;align-items:stretch;gap:8px;}.search-field{gap:4px;}.compact-input,.compact-input.w-date,.compact-input.w-sm,.compact-input.w-md,.compact-input.w-lg{width:100% !important;font-size:16px;height:44px;}.search-sep{display:none;}.date-range{flex-direction:row !important;gap:4px;}.date-range .compact-input{flex:1;width:auto !important;font-size:14px;height:44px;}.search-actions{margin-left:0;margin-top:4px;}.search-actions .btn{flex:1;}}'
            . '</style>'
            . '</head>'
            . '<body>'
            . $headerHtml
