CREATE TABLE IF NOT EXISTS t_accident_case (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uq_t_accident_case_01 (accident_no),
  ...
  CONSTRAINT fk_t_accident_case_01
    FOREIGN KEY (customer_id) REFERENCES m_customer(id),
  CONSTRAINT fk_t_accident_case_02
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='事故案件';