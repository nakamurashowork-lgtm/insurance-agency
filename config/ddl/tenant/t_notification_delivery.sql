CREATE TABLE IF NOT EXISTS t_notification_delivery (
  ...
  CONSTRAINT fk_t_notification_delivery_01
    FOREIGN KEY (notification_run_id) REFERENCES t_notification_run(id),
  CONSTRAINT fk_t_notification_delivery_02
    FOREIGN KEY (renewal_case_id) REFERENCES t_renewal_case(id),
  CONSTRAINT fk_t_notification_delivery_03
    FOREIGN KEY (accident_case_id) REFERENCES t_accident_case(id),
  CONSTRAINT fk_t_notification_delivery_04
    FOREIGN KEY (renewal_reminder_phase_id) REFERENCES m_renewal_reminder_phase(id),
  CONSTRAINT fk_t_notification_delivery_05
