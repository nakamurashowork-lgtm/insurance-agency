CREATE TABLE IF NOT EXISTS t_contract (
  ...
  sales_user_id       BIGINT UNSIGNED NULL COMMENT '営業担当(common.users.id)',
  office_user_id      BIGINT UNSIGNED NULL COMMENT '事務担当(common.users.id)',
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uq_t_contract_01 (policy_no),
  ...
  KEY idx_t_contract_05 (sales_user_id),
